...
HTML_BANNER = """
    <div style="background-color:#0096FF;padding:10px;border-radius:10px">
    ...
    if choice == "Create":
        ...
        if task_result:
            ...
            if st.button("Update Task"):
                edit_task_data(new_task, new_task_status,
                               new_task_due_date, task, task_status, task_due_date)
            ...
            with st.expander("View Updated Data"):
                ...
                clean_df = pd.DataFrame(
                    result, columns=["Task", "Status", "Date"])
                st.dataframe(clean_df)
        ...
        st.info("Copyright@2023")
        st.text("by Ari_Andriant")
